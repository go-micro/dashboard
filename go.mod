...
require (
	...
	github.com/go-micro/plugins/v4/client/mucp v1.2.0
	...
	github.com/go-micro/plugins/v4/registry/eureka v1.2.0
	github.com/go-micro/plugins/v4/registry/gossip v1.2.0
	github.com/go-micro/plugins/v4/registry/kubernetes v1.1.1
	github.com/go-micro/plugins/v4/registry/nacos v1.2.0
